...
export default function MainGame({showConfetti, setShowConfetti, track, setTrack, balance, setBalance}) {
  ...
  return (
    <div >
      ...
      {/* amt input box */}
      <div className="flex justify-center mt-3 text-md lg:text-2xl text-white ">
      ...
      {/* diceboard */}
      <div className="diceBoard flex justify-center items-center text-white text-2xl gap-15 bg-[#414040] w-[80%] lg:w-[60%] rounded-2xl mx-auto mt-3 pb-4">
      ...
      <div className="result flex flex-col items-center justify-center m-3 text-gray-300 pb-3">
        <h3>{ msg }</h3>
        <p className=" text-gray-200 text-center text-xs hover:cursor-default">Press the top right button to veiw Scores.</p>
      </div>  
