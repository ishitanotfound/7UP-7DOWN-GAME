...
export default function MainGame({showConfetti, setShowConfetti, track, setTrack, balance, setBalance}) {
  ...
  return (
    <div >
      ...
      {/* amt input box */}
      <div className="flex justify-center mt-4 text-md lg:text-2xl text-white ">
      ...
      {/* diceboard */}
      <div className="diceBoard flex justify-center items-center text-white text-2xl gap-15 bg-[#414040] w-[80%] lg:w-[60%] rounded-2xl mx-auto mt-4 pb-4">
